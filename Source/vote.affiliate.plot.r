...
# of votes versus number of total votes.
...
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
cat("start plot vote affiliate counts\n");
tic <- proc.time();
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
	...
	total.range <- c(0, max(new.total.data, regular.total.data));
...
toc <- proc.time() - tic;
cat(toc);
cat(" - done plot vote affiliate counts\n");
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
}