...
# of votes versus number of total electors.
...
# Declare signature
elector.affiliate.plot <- function(
	haystack.data,
	file.name = "",
...
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
cat("start plot elector affiliate counts\n");
tic <- proc.time();
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
	...
	elector.range <- c(0, max(new.elector.data, regular.elector.data));
...
toc <- proc.time() - tic;
cat(toc);
cat(" - done plot elector affiliate counts\n");
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
}