...
# of votes versus fraction of rejected ballots.
...
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
cat("start plot reject affiliate fractions\n");
tic <- proc.time();
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
...
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
	...
	for (needle.instance in thimble.data) {
		...
		# Stick the needles in the pincushion
		new.votes.data <- haystack.data[needle.index, elector.dimension] / new.total.data;
		...
		# Stick the needles in the pincushion
		regular.votes.data <- haystack.data[needle.index, elector.dimension] / regular.total.data;
...
toc <- proc.time() - tic;
cat(toc);
cat(" - done plot reject affiliate fractions\n");
# # # # # # # # # # # # # # # # # # # # # # Debug code # # # # # # # # # # # # # # # # # # # # # #
}